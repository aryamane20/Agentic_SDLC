...
const CAPABILITY_CARDS: {
  ...
  },
  {
    ...
    description:
      "Approve or reject, then refine. Intake stays stable so the plan does not drift without you knowing.",
    image:
...
/** Rotating words users recognize; same pillars as the report (no jargon). */
...
export default function App() {
  return (
    <div className="bg-black text-zinc-100">
      {/* Particle hero — slightly under full viewport so about peeks sooner */}
      <section
      ...
      <main>
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <Button type="button" disabled title="Wire-up next">
              Get started
                  ...
                  >
                    <CardCurtainReveal className="h-full w-full rounded-xl border border-zinc-800 bg-black/40">
                      <CardCurtainRevealBody className="relative flex flex-col">
                        <Icon
                          className="mb-3 h-8 w-8 shrink-0 text-zinc-300"
                          strokeWidth={1.5}
                          aria-hidden
                        />
                        ...
                        <CardCurtainRevealDescription className="text-sm leading-relaxed text-zinc-500">
                          <p>{description}</p>
                        </CardCurtainRevealDescription>
